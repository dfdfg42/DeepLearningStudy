...
from DL_Lecture.utils.text_prepro import text_to_indices, clean_str
...
def main():
    ...
    if params['task'] == "EN2DE":
        ...
        for i in range(params["batch_size"]):
            test_source_text.append(clean_str("Where is the bathroom?", True))
            test_target_text.append(clean_str("Où sont les toilettes?", True))
    ...
    print("target_sentence:", " ".join(target_sentences[0][0]))
    print("inference_sentence:", " ".join(inference_sentences[0]))
